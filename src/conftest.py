...
@pytest.fixture(scope='function')
def db_fill(tf_output, aoi, h3_indices, geom):
    db_name = tf_output['table_name']
    aws_region = tf_output['aws_region']
